...
RUN curl --silent --output fabric8.zip https://repository.jboss.org/nexus/content/repositories/fs-snapshots/io/fabric8/runtime/fabric8-tomcat/1.1.0-SNAPSHOT/fabric8-tomcat-1.1.0-20140402.142713-2.zip
